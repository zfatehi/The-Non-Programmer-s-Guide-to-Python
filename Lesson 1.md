...
The print function lets me print anything I want, from a variable, to a string(a bunch of text enclosed in quotation marks), to a string at a specific location, and it starts the numbering from 0:
