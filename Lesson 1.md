...
The print function lets me print anything I want, from a variable, to a string (a bunch of characters enclosed in quotation marks), to a string at a specific location which starts being numbered from 0:
